...
After running the container from Lesson 4:
...
This concludes Chapter 2. In Chapter 3 we leave the toy examples
behind and start applying everything we learned to the RAG
application: building the development image, mounting source code
and model caches, and wiring multiple services together.
